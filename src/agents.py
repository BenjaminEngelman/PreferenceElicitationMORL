...
class MultiObjectiveDQN(DQN):
    def __init__(self):
        super(MultiObjectiveDQN).__init__()
    
    def learn(self, total_timesteps, weights, callback=None, log_interval=100, tb_log_name="DQN",
