# Code from https://github.com/RunzheYang/MORL/blob/9e01c305c2abc9938408de49bb6cea4aca03e44c/synthetic/envs/deep_sea_treasure.py
...
class DeepSeaTreasure(object):
    ...
    def step(self, action):
        ...
        def valid(x, ind): return (x[ind] >= self.state_spec[ind][2][0]) and (
