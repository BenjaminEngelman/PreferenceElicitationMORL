...
all_weights = np.linspace(0, 1, 100)

res = {}
for i, weights_0 in enumerate(all_weights):#WEIGHTS_COMP_BST:
    weights = np.array([weights_0, 1-weights_0])
    ...
    with open(f'experiments/bst/results_linspace.pickle', 'wb') as handle:
